...
import numpy as np
from models.commons.wavenet import WN
from models.tts.glow import utils
...
class InvConvNear(nn.Module):
    def __init__(
        ...
        w_init = torch.linalg.qr(
            torch.FloatTensor(self.n_split, self.n_split).normal_(), mode='reduced'
        )[0]
